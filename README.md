...
აღნიშნული ინსტრუმენტი საშუალებას იძლევა სწრაფად შეამოწმოს თითეულ IP მისამართზე პორტი ღიაა თუ არა.
IP მისამართები და ღია პორტები, დროის მითითებით შეინახება ტექსტურ ფაილში სახელად `port-scan-result.txt`, შემდგომი ანალიზისთვის. 
